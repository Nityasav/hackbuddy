...
import { Loader2, LogIn, User, Key, AlertCircle } from "lucide-react";
      ...
      <main className="flex-1 flex items-center justify-center pt-16 pb-16 px-4">
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-2 neon-text">Welcome to <span className="text-primary">Hack</span>Buddy</h1>
            <p className="text-foreground/70">Sign in to find your perfect hackathon teammates</p>
          </div>
